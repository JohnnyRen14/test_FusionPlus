...
import { FusionApi, QuoterRequest, RelayerRequestEvm, QuoterCustomPresetRequest, ActiveOrdersRequest, OrdersByMakerRequest, OrderStatusRequest, RelayerRequestSvm } from '../api';
import { isEvm, NetworkEnum } from '../chains';
export class SDK {
    constructor(config) {
        this.config = config;
