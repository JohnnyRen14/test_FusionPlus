...
class SDK {
    ...
    async submitOrder(srcChainId, order, quoteId, secretHashes) {
        ...
        const relayerRequest = new api_1.RelayerRequestEvm({
            srcChainId,
            order: orderStruct,
            signature,
            quoteId,
    ...
    async announceOrder(order, quoteId, secretHashes) {
        ...
        const relayerRequest = new api_1.RelayerRequestSvm({
            order: order.toJSON(),
            quoteId,
            secretHashes: secretHashes.length === 1 ? undefined : secretHashes
        });
        await this.api.submitOrder(relayerRequest);
        return order.getOrderHash(chains_1.NetworkEnum.SOLANA);
    }
    ...
    async buildCancelOrderCallData(orderHash) {
        ...
        (0, assert_1.default)((0, chains_1.isEvm)(orderData.srcChainId) && 'extension' in orderData, // extension check needed for TS
